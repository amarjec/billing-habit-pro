...
// import { User, MapPin, Phone, EyeOff, Download, Briefcase, Save } from "lucide-react";
...
//         const resProducts = await axios.post("/product/get-details-for-list", {
//           productIds,
//         });
...
//             // Master Prices for "Modified" check
...
//     return itemsTotal + (parseFloat(fare) || 0) - (parseFloat(disc) || 0);
//   };
...
//     const fileName = quote.customer?.name
//       ? `Quote_${quote.customer.name}`
//       : `Quote_${quote._id.slice(-6)}`;
...
//       <div className="fixed top-0 right-0 z-60 h-14 flex items-center pr-2 gap-1 no-print">
//         <button
...
//             <div
//               className={`relative flex items-center px-2 py-1 rounded-md border ${
...
//                 className="appearance-none bg-transparent font-bold text-xs pr-4 focus:outline-none cursor-pointer"
//               >
...
//           </div>
//           <div
//             className={`hidden print:block absolute top-4 right-4 text-xs font-bold border px-2 py-1 rounded ${STATUS_COLORS[status]}`}
//           >
//             {status}
//           </div>

//           <div className="flex items-start gap-3">
//             <div className="h-10 w-10 mt-1 rounded-full bg-green-50 flex items-center justify-center border border-green-100 shrink-0">
...
//                 </h3>
//                 {isQuoteWholesale && (
//                   <span className="bg-purple-100 text-purple-700 text-[9px] font-bold px-1.5 py-0.5 rounded border border-purple-200 flex items-center gap-0.5">
//                     <Briefcase size={8} /> Wholesale
//                   </span>
//                 )}
//               </div>
...
//                     <Phone size={14} /> {quote.customer.number}
//                   </span>
//                 )}
...
//         {/* Items List (Using Shared Component) */}
...
//           onFareChange={(val) => {
//             setExtraFare(val);
//             setTotal(recalculateTotal(quoteItems, val, discount));
//           }}
//           onDiscountChange={(val) => {
//             setDiscount(val);
//             setTotal(recalculateTotal(quoteItems, extraFare, val));
//           }}
//         />
//       </div>
...
//             disabled={isSaving}
//             className="no-print w-full py-3.5 rounded-xl text-white font-bold text-lg flex items-center justify-center gap-2 bg-primaryColor hover:bg-green-700 disabled:bg-gray-300"
//           >
//             {isSaving ? (
